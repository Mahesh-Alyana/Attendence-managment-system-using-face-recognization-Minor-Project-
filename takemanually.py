    ...
    def fill_attendance():
        ...
        if subb == "":
            ...
            def create_csv():
                df = pd.DataFrame(d)
                csv_name = (
                    "D:/Programming/Attendence-managment-system-using-face-recognization-Minor-Project--akash/Attendence-managment-system-using-face-recognization-Minor-Project--akash/Attendance(Manually)/"
                    + subb
                    + "_"
                    + Date
                    + "_"
